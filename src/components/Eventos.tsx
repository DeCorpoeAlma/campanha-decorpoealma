...
import { Clock, MapPin, Users, Calendar, ExternalLink, Play } from 'lucide-react';
...
const Eventos = () => {
  ...
  const allItems: CombinedItem[] = [...events, ...newsItems].sort((a, b) => {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Acompanhe os últimos desenvolvimentos da campanha, entrevistas, encontros com os cidadãos de Faro e os próximos eventos.
          </p>
        </div>
